...
CREATE TABLE IF NOT EXISTS shipping (
    ...
    shipping_cost_units INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS orderitem (
    ...
    item_cost_units INTEGER NOT NULL,
    item_cost_nanos INTEGER NOT NULL,
...
CREATE INDEX IF NOT EXISTS product_id_index ON productreviews (product_id);

-- Product Review Service: add product review data
INSERT OR IGNORE INTO productreviews (product_id, username, description, score)
VALUES
...
INSERT OR IGNORE INTO products (id, name, description, picture, price_currency_code, price_units, price_nanos, categories)
VALUES
