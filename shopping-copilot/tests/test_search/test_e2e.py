...
shopping_copilot_root = Path(__file__).parent.parent
...
class E2ETestRunner:
    ...
    def print_setup_instructions(self):
        ...
        logger.info(f"\nThen test with:")
        logger.info("  python tests/test_search/test_e2e.py \"kính thiên văn dưới 100 đô\"")
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python tests/test_search/test_e2e.py "kính thiên văn"
  python tests/test_search/test_e2e.py "dưới 100 đô"
  python tests/test_search/test_e2e.py "ống nhòm rẻ nhất"
        """
    )
