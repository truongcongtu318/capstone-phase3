...
Chạy bằng: python tests/test_search/test_interactive.py
...
class TestRunner:
    ...
    def test_regex_parsing(self):
        ...
        from src.tools.search.query_analyzer import RegexQueryAnalyzer
    ...
    def test_interactive(self):
        ...
        logger.info("  from src.tools.search.orchestrator import SearchOrchestrator")
